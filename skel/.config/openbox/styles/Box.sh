...
# wallpaper ---------------------------------
nitrogen --save --set-zoom-fill --head=0 /home/fewcm/Pictures/nord-theme/FRxscG4.png 
nitrogen --save --set-zoom-fill --head=1 /home/fewcm/Pictures/whitelotus.jpg

# polybar ---------------------------------
sed -i -e 's/STYLE=.*/STYLE="pinknord"/g' $polybar_path/launch.sh
...
# rofi ---------------------------------
sed -i -e 's/STYLE=.*/STYLE="pinknord"/g' "$rofi_path/bin/mpd" "$rofi_path/bin/network" "$rofi_path/bin/screenshot"
sed -i -e 's/DIR=.*/DIR="pinknord"/g' "$rofi_path/bin/launcher" "$rofi_path/bin/powermenu"
...
sed -i -e 's/border:.*/border:					3px;/g' "$rofi_path/dialogs/askpass.rasi" "$rofi_path/dialogs/confirm.rasi"
